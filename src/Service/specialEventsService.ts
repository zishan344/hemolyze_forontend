...
export type EventIconComponent = React.ComponentType<LucideProps>;
...
export interface SpecialEvent {
  ...
  endDate: Date;
  description: string;
  // Store component type and props instead of the element
  IconComponent: EventIconComponent;
  iconProps: Omit<LucideProps, "ref">; // Store props separately
  icon?: string;
  modalTitle: string;
...
export const specialEvents: SpecialEvent[] = [
  {
    ...
    IconComponent: Heart,
    iconProps: { className: "text-primary-content", size: 18 },
  ...
  {
    id: "holiday-season-appeal",
    name: "Holiday Season Appeal",
  ...
  {
    id: "summer-blood-drive",
    name: "Critical Summer Blood Drive",
